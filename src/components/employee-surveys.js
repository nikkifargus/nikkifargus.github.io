  ...
  <div className="">
    <div className="row">
      ...
      >
        ...
        <p className="text-orange"> SCALEUP- LEADER GUIDE </p>
        <p className="text-orange"> ENHANCING YOUR LEADERSHIP </p>
      ...
      <div className="col-lg-5 col-sm-12" style={{ margin: 'auto 0'}}>
        ...
        <p> - Visit <a href="https://www.scaleup-leader.guide/" >Scaleup-Leader.Guide</a> for more information</p>
      </div>
    </div>
  </div>
);
